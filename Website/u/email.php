...
<p style="font-size: 14px; line-height: 16px; text-align: left; margin: 0;"><strong>Mail from Mogi</strong></p>
</div>
</div>
...
<p style="line-height: 60px; font-size: 12px; margin: 0;"><span style="font-size: 50px;">Hey <?php echo $_SESSION['name']; ?>, you got the badge!</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
</div>
...
<div style="font-size:1px;line-height:10px"> </div><img align="center" alt="Image" border="0" class="center autowidth fullwidth" src="images/divider.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 634px; display: block;" title="Image" width="634"/>
<!--[if mso]></td></tr></table><![endif]-->
</div>
<!--[if (!mso)&(!IE)]><!-->
</div>
...
<p style="line-height: 25px; text-align: left; font-size: 12px; margin: 0;"><span style="font-size: 17px; mso-ansi-font-size: 18px;">Hey congratolations for your badge, you're really lucky!</span></p>
<p style="line-height: 25px; text-align: left; font-size: 12px; margin: 0;"><span style="font-size: 17px; mso-ansi-font-size: 18px;">In order to integrate the badge in your footer, just copy and paste the code down below.</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
...
<p style="font-size: 12px; line-height: 14px; color: #555555; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; margin: 0;">Mail designed by <a href="https://moonmatt.dev" rel="noopener" style="text-decoration: underline; color: #66BECD;" target="_blank">moonmatt</a></p>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
</div>
