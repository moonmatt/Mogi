            ...
            if (isset($_POST['submit'])) {
                ...
                if ($name == "index" || $name == "error" || $name == "yay") {
                    ...
                    if (file_exists($fname)) { // If the page already exists
                        $fnamecontent = file_get_contents($fname);
                        $pos = strpos($fnamecontent, $bname);
                        if ($pos === false) {
                            ...
                            header("Location: error.php?you-already-have-this-badge"); // Redirects to error.php
                            die();
                        }
                        ...
                        header("Location: error.php?no-badges-left"); // Redirects to error.php
                        die();
                    }
        }else{
            header("Location: error.php"); // Redirects to error.php
            die();
        }
    }
}
